...
print("info" + email_domain)       # Output: info@datawithbaraa.com
print("support" + email_domain)    # Output: support@datawithbaraa.com
print(link)                        # Output: www.datawithbaraa.com
